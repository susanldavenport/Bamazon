# Title: Bamazon: A Node Shopping Experience
### Contributor:       Susan Davenport
### GitHub URL:        https://github.com/susanldavenport/bamazon
### Video Example URL: 

This is a node-based application that demonstrates the use of javascript and sql inside of node. Users are able to interact in the command line through an inquirer NPM package.
